...
import {
  Settings, User, Mail, Shield, Save, Key,
        ...
        <div class="max-w-2xl mx-auto space-y-6">
            ...
            <div class="p-6 space-y-5">
              ...
              <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">
                  <Mail class="h-3 w-3 inline mr-1" /> Email
                </label>
          ...
          <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="px-6 py-5 border-b border-gray-100 flex items-center">
              ...
              <h3 class="text-base font-bold text-gray-900">Preferences</h3>
            </div>
            <div class="p-6 space-y-4">
              <label class="flex items-center justify-between">
                <span class="text-sm text-gray-700">Email notifications for new submissions</span>
                <input type="checkbox" checked class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
              </label>
              <label class="flex items-center justify-between">
                <span class="text-sm text-gray-700">Auto-grade multiple choice quizzes</span>
                <input type="checkbox" checked class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
              </label>
              <label class="flex items-center justify-between">
